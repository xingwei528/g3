...
function syncFile(g3Config, sourceDirs, p) {
    ...
    if (dirpath === g3Config._g3Path || dirpath === g3Config.destination)
        return;
    var rel = lib.pathRelative(g3Config.source, p);
    var g3Path = path.join(g3Config._g3Path, lib.pathRelative(g3Config.source, p));
    if (ext === '.js' || ext === '.jsx') {
        ...
        var key_1 = lib.pathRelative(g3Config.source, dirpath_1);
        ...
        var g3PublicPath = path.join(g3Config.destination, lib.pathRelative(g3Config._appPath, p));
