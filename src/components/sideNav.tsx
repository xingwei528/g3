  ...
  render() {
    return (
      <div id="side_nav" role="navigation">
          <h1><IndexLink to={links.INDEX} id="logo">BAIRONG.IO</IndexLink></h1>
          <h2>Who we are</h2>
          <ul>
              <li><Link to={links.TEAM} activeClassName="active"><i className="icon team" /> <span>Our team</span></Link></li>
              <li><Link to={links.ABOUT} activeClassName="active"><i className="icon about" /> <span>About us</span></Link></li>
          </ul>
          <h2>What We Do</h2>
          <ul>
